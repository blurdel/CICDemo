...
#
# For the server, I chose to use port 8080, ie: localhost:8080
#
...
docker run --name local_jenkins -d -p 8080:8080 -p 50000:50000 -v /opt/docker/jenkins/jenkins_home:/var/jenkins_home  jenkins/jenkins:lts
